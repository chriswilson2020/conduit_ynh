...
**Mail accounts sign in with a password out of the box.** Signing a Microsoft 365 or Google mailbox in at the provider instead is supported, but it needs a one-time app registration made by an administrator of your tenant -- see the admin documentation on this app's page after installation for what to create and where to put it.
